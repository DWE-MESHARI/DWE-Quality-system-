...
const PAL=['#0284C7','#38BDF8','#0C4A6E','#7DD3FC','#64748B'];
...
const TC={d:'#0284C7',v:'#059669',b:'#7C3AED',e:'#EA580C',r:'#DB2777',m:'#4F46E5',l:'#475569',s:'#0D9488'};
...
const MC={q:'#0284C7',f:'#7C3AED',c:'#059669',a:'#EA580C',p:'#DB2777',calls:'#0891B2',cm:'#DC2626',star:'#F59E0B',tg:'#0284C7'};
...
const EP=['#0284C7','#DB2777','#7C3AED','#059669','#EA580C','#CA8A04','#0D9488','#DC2626','#4F46E5','#65A30D'];
...
const LC={'ممتاز':'#16A34A','جيد جدًا':'#2563EB','يحتاج تحسين':'#F59E0B','تدخل فوري':'#DC2626'};
...
function draw(){
 ...
 Chart.defaults.color=dark?'#C9D6DA':'#3a4a52';Chart.defaults.font.family='Tajawal,Tahoma';Chart.defaults.borderColor='rgba(128,128,128,.22)';
...
function pDash(){
 ...
 mk('c2',{type:'line',data:{labels:ds,datasets:[...by.map(x=>({label:x.e.name,data:tm(r=>r.emp===x.e.id),borderColor:EC(x.e.id),backgroundColor:EC(x.e.id),tension:.3,spanGaps:true,pointRadius:4,borderWidth:2.5})),{label:'متوسط الفريق',data:tm(()=>1),borderColor:'#0C4A6E',backgroundColor:'#0C4A6E',borderDash:[6,4],tension:.3,spanGaps:true,pointRadius:0}]},options:{responsive:true,maintainAspectRatio:false,plugins:{legend:{position:'bottom',rtl:true}},scales:{y:{min:0,max:100}}}});
